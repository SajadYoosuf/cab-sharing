        ...
        children: [
          ...
          _buildActionItem(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => const AdminVerificationListPage(),
              ),
            ),
          ),
          _buildActionItem(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () => Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) =>
                      AdminRideDetailPage(rideData: data, rideId: rideId),
                ),
              ),
              child: Container(
                margin: const EdgeInsets.only(bottom: 12),
            ...
            return Container(
              ...
              child: ListTile(
                ...
                leading: CircleAvatar(
                  backgroundColor: userModel.isBanned
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (user.banExpiryDate != null)
                                Text(
                                  'Expires: ${_formatDate(user.banExpiryDate!)}',
                                  style: TextStyle(
                                    color: Colors.red.shade800,
                                    fontSize: 12,
                                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        if (selectedDuration == '2 Weeks')
                          expiry = now.add(const Duration(days: 14));
                        if (selectedDuration == '2 Months')
                          expiry = now.add(const Duration(days: 60));
                        if (selectedDuration == '2 Years')
