...
class AdminFeedbackPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Ride RideFeedback', style: GoogleFonts.outfit(fontWeight: FontWeight.bold)),
      ...
      body: StreamBuilder<List<RideFeedback>>(
  ...
  Widget _buildFeedbackCard(BuildContext context, RideFeedback feedback) {
    return Container(
