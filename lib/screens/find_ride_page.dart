...
import 'package:ride_share_app/services/location_service.dart';
...
class _FindRidePageState extends State<FindRidePage> {
  ...
  Widget _buildRideCard(BuildContext context, Ride ride, double? distance) {
  ...
  Widget _buildCardFooter(Ride ride, DateFormat d, DateFormat t) {
    return Row(
